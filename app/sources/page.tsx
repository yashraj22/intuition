...
const SourcesPage = () => {
	...
	const handleRemoveFeed = (source: Source) => {
		removeSourceItem(source);
		deleteSource(source.id);
		console.log(source);
		const updatedFeeds = feeds.filter((feed) => feed.url !== source.url);
		localStorage.setItem("rssFeeds", JSON.stringify(updatedFeeds));
		setFeeds(updatedFeeds);
